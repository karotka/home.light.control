...
****************************************************************************/
void TWI_SlaveInitialise(uint8_t);
unsigned char TWI_TransceiverBusy(void);
unsigned char TWI_GetStateInfo(void);
void TWI_StartTransceiverWithData(uint8_t *, uint8_t);
void TWI_StartTransceiver(void);
unsigned char TWI_GetDataFromTransceiver(uint8_t *, uint8_t);
